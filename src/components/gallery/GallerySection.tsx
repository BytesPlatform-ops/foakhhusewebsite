...
const ITEMS: GalleryItem[] = [
  {
    ...
    alt: "Dusk frontal view of the two residential blocks, windows warm against the evening sky",
    category: "Architecture",
    title: "The dusk approach",
    aspect: "aspect-[4/4.6]",
  },
  {
    src: "/env-solar.jpg",
    alt: "Rooftop solar panels catching low golden light",
  ...
  },
  {
    ...
    category: "Details",
    title: "Airflow opening",
    aspect: "aspect-[3/3.6]",
  },
  {
    src: "/route-exterior.jpg",
    alt: "Rooftop energy systems above the development at first light",
    category: "Rooftop systems",
    title: "Systems at first light",
    aspect: "aspect-[16/10]",
  },
  {
    ...
    category: "Residences",
    title: "The sheltered court",
    aspect: "aspect-[4/5]",
  },
  {
    src: "/env-context.jpg",
    alt: "The development within its wider green landscape",
  ...
  {
    src: "/route-solar.jpg",
    alt: "Low-angle view across the rooftop solar array within the terracotta architecture",
    category: "Rooftop systems",
    title: "The panel field",
    aspect: "aspect-[16/10]",
  },
  {
    src: "/hero-poster.jpg",
