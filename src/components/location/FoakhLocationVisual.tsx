...
export default function FoakhLocationVisual() {
  return (
    <figure className="relative overflow-hidden rounded-[28px] border border-[#C99355]/45 bg-gradient-to-br from-[#FAF6F0] to-[#F3E2C8] shadow-[0_30px_60px_-30px_rgba(90,45,22,0.35)]">
