...
const AMENITIES: Amenity[] = [
  {
    ...
    alt: "Residents relaxing in the warm sheltered court of the development",
    pos: "50% 38%",
  },
  {
    num: "02",
    ...
    src: "/hero-poster.jpg",
    alt: "The twelve-storey rise of the residences in the evening light",
  },
  {
    num: "03",
    ...
    alt: "Daylight and airflow moving along the internal circulation corridor",
    pos: "50% 42%",
  },
  {
    num: "04",
    ...
    alt: "The organised infrastructure of the development at first light",
  },
  {
    num: "05",
    ...
    src: "/env-context.jpg",
    alt: "The green shared landscape surrounding the development",
  },
  {
    num: "06",
    title: "24/7 Security",
    ...
    alt: "The controlled entrance approach of the residences at dusk",
    pos: "50% 55%",
  },
  {
    num: "07",
    ...
    src: "/env-air.jpg",
    alt: "The sunlit terracotta architectural opening with moving air",
    pos: "60% 40%",
  },
  {
    num: "08",
    ...
    src: "/route-solar.jpg",
    alt: "Rooftop building systems within the terracotta architecture",
  },
];
